 ...
 */
public class PayloadTermsQuery extends Query implements Accountable {

  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(PayloadTermsQuery.class);
   ...
   * a single field.
   */
  public PayloadTermsQuery(final String field, final List<BytesRef> terms) {
   ...
   * a single field.
   */
  public PayloadTermsQuery(final String field, final BytesRef...terms) {
   ...
   */
  public PayloadTermsQuery(final Term... terms) {
  ...
  public boolean equals(Object obj) {
    ...
    PayloadTermsQuery that = (PayloadTermsQuery) obj;
    ...
    return new ConstantScoreWeight(this) {
      ...
      private WeightOrDocIdSet rewrite(LeafReaderContext context) throws IOException {
        ...
        if (matchingTerms != null) {
          ...
          System.out.println("Constant Scoring!");
