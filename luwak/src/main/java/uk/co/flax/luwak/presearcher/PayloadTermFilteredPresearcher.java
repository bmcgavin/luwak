 ...
 */
public class PayloadTermFilteredPresearcher extends Presearcher {
    ...
    public PayloadTermFilteredPresearcher(TreeWeightor weightor, PresearcherComponent... components) {
        this.extractor = QueryAnalyzer.fromComponents(weightor, components);
        this.components.addAll(Arrays.asList(components));
    }

    public PayloadTermFilteredPresearcher(PresearcherComponent... components) {
        this(TreeWeightor.DEFAULT_WEIGHTOR, components);
    }

    public PayloadTermFilteredPresearcher() {
        ...
        try {
            ...
            for (String field : reader.fields()) {
                ...
                for (PresearcherComponent component : components) {
                    if (System.getProperty("luwak.debug", "false").equals("true")) System.out.println("tokenstream (midloop) : " + ts);
    ...
    protected DocumentQueryBuilder getQueryBuilder() {
        return new DocumentQueryBuilder() {
            ...
            public Query build() {
                ...
                return new PayloadTermsQuery(terms);
            }
        };
    }
